...
const myMap = new Map(jokes.map((joke) => [joke.id, joke]));
const objJokes = Object.fromEntries(myMap);
const getRandomJoke = async () => {
    const randomJoke = Math.floor(Math.random() * Object.values(objJokes).length);
    return Object.values(objJokes)[randomJoke];
};

export { objJokes, getRandomJoke};